...
"""
FILE:           dbrks_ndc_transactions_nhsapp_research_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M270: Research
USAGE:
                ...
CONTRIBUTORS:   Mattia Ficarelli, Kabir Khan, Chris Todd
CONTACT:        data@nhsx.nhs.uk
CREATED:        21th Apr 2023
VERSION:        0.0.3
"""
