...
"""
FILE:           dbrks_ndc_dashboard_nhsapp_registered_population_month_prop.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M220: % English adult population registered for NHS App
USAGE:
                ...
