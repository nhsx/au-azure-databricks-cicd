...
"""
FILE:           dbrks_ndc_dashboard_nhsapp_secondary_care_appointments_month_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M226: Secondary care appointments via NHS App
USAGE:
                ...
