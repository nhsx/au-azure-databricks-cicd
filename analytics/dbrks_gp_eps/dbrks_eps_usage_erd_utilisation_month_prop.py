...
"""
FILE:           dbrks_eps_usage_erd_utilisation_month_prop.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric: ERD utilisation (% all items) (M085)
USAGE:
                ...
...
df1 = df[['ODS Code', 'eRD Items', 'All Items', 'eRD Utilisation (All Items)', 'Date']]
