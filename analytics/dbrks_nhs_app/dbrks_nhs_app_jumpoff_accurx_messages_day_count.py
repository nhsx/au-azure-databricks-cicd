...
"""
FILE:           dbrks_nhs_app_jumpoff_accurx_messages_day_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M0180: accurx - messagesJump Off Clicks
                
USAGE:          ...
CONTRIBUTORS:   Everistus Oputa, Chris Todd
...
table_name = config_JSON['pipeline']['staging'][18]['sink_table']
...
df1 = df1[(df1['JumpOff']=='messages') & (df1['Provider']=='Accurx Limited')]
...
df4 = df3.rename(columns = {'OdsCode': 'Practice code', 'Clicks': 'Number of accurx - messages Jump Off Clicks'})
