...
"""
FILE:           dbrks_nhs_app_jumpoff_accurx_medical_day_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M0181: accurx - medicalJump Off Clicks
...
df1 = df1[(df1['JumpOff']=='medical') & (df1['Provider']=='Accurx Limited')]
...
df4 = df3.rename(columns = {'OdsCode': 'Practice code', 'Clicks': 'Number of accurx - medical Jump Off Clicks'})
