...
df1['ODLookups'] = pd.to_numeric(df1['ODLookups'],errors='coerce').fillna(0)
df2 = df1.groupby(['Date','OdsCode']).sum().reset_index()
df3 = df2.rename(columns = {'OdsCode': 'Practice code', 'ODLookups': 'Number of organ donation lookups'})
