...
"""
FILE:           dbrks_nhs_app_jumpoff_pkb_appointments_day_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M0166: 	
                PKB - appointments Jump Off Clicks (GP practice level)
USAGE:
                ...
CONTRIBUTORS:   Mattia
...
df1 = df1[((df1['JumpOff']=='appointments')| (df1['JumpOff']=='appointmentsCie'))  & (df1['Provider']=='Patients Know Best')]
...
df4 = df3.rename(columns = {'OdsCode': 'Practice code', 'Clicks': 'Number of PKB - appointments Jump Off Clicks'})
