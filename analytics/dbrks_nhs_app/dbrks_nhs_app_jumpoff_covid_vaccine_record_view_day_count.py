...
"""
FILE:           dbrks_nhs_app_jumpoff_covid_vaccine_record_view_day_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analyticus unit metric M0165: Covid Vaccine Record ViewJump Off Clicks (GP practice level)
USAGE:
                ...
CONTRIBUTORS:   Everistus Oputa, Kabir Khan
CONTACT:        data@nhsx.nhs.uk
CREATED:        2nd Aug 2022
VERSION:        0.0.1
"""
...
#Processing
# ---------------------------------------------------------------------------------------------------
df1 = df[["Date", "OdsCode", "JumpOff","Clicks", "Provider"]].copy()
df1['Clicks'] = df1['Clicks'].astype(int)
df1 = df1[(df1['JumpOff']=='vaccineRecord') & (df1['Provider']=='NHS Digital')]
...
df4 = df3.rename(columns = {'OdsCode': 'Practice code', 'Clicks': 'Number of Covid Vaccine Record ViewJump Off Clicks'})
