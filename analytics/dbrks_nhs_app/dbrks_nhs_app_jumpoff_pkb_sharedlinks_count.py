...
"""
FILE:           dbrks_nhs_app_jumpoff_pkb_sharedlinks_count.py
DESCRIPTION:
                Databricks notebook with processing code for the NHSX Analytics unit metric M0173: PKB sharedLinks Jump Off Clicks (GP practice level)
USAGE:
                ...
...
df1 = df1[((df1['JumpOff']=='sharedLinksCie')| (df1['JumpOff']=='sharedLinks'))  & (df1['Provider']=='Patients Know Best')]
...
df4 = df3.rename(columns = {'OdsCode': 'Practice code', 'Clicks': 'Number of PKB sharedlinks'})
