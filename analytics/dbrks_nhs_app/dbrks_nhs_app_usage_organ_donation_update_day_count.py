...
df1['ODUpdates'] = pd.to_numeric(df1['ODUpdates'],errors='coerce').fillna(0)
df2 = df1.groupby(['Date','OdsCode']).sum().reset_index()
df3 = df2.rename(columns = {'OdsCode': 'Practice code', 'ODUpdates': 'Number of organ donation updates'})
