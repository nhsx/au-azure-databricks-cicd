...
DESCRIPTION:
                Databricks notebook with processing code for the CQC digital social care records
USAGE:         
                ...
CONTRIBUTORS:   
...
df_join_keep = df_join[df_join["Last_Refreshed"]==max(df_join["Last_Refreshed"])][["Location_Id",
                        ...
                        "Provider_NHS_Region","Is_Care_Home","Care_Home_Beds","Provider_Postal_Code","Location_Postal_Code","Is_Domant","Location_HSCA_Start_Date",
                         "monthly_date"]].copy()   
...
df_tab03_patch = df_merged_hcsu_df_join_keep.merge(df_pir_keep_unit2, how ='left', on ="Location_Id")
df_tab03_patch .rename(columns={"ServiceUserCount":"Dom_ServiceUserCount"},inplace=True)
