...
"""
FILE:           dbrks_supplier_socialcare_count.py
DESCRIPTION:
                Databricks notebook with processing code for the suppliers of socialcare count (TBD)
USAGE:
                ...
...
file_name_config = "config_supplier_socialcare_dbrks.json"
