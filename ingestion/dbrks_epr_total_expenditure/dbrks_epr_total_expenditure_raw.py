...
"""
FILE:           dbrks_epr_total_expenditure_raw.py
DESCRIPTION:
                Databricks notebook with code to append and check new raw data to historical
                data for the DCT metrics within the topic Epr Total Expenditure
USAGE:
                ...
...
# Install libs
# -------------------------------------------------------------------------
%pip install geojson==2.5.* tabulate requests pandas pathlib azure-storage-file-datalake beautifulsoup4 numpy urllib3 lxml regex pyarrow==8.0.* xlrd openpyxl python-dateutil
...
file_name_config = "config_epr_total_expenditure.json"
